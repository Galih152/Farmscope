    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Form Tambah</h6>
                <h4 class="display-5 text-uppercase mb-0">Tambah Produk</h4>                
            </div>
            <div class="formbold-main-wrapper">
                  <form action="servernya/upload_produk-sapi.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="formbold-mb-3">
                      ...
                      <!-- <textarea type="text" name="deskripsi" id="deskripsi" class="formbold-form-input" ></textarea> -->
                      <textarea
                      rows="6"
                      name="deskripsi"
                      id="deskripsi"
