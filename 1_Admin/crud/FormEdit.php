            ...
            <div class="col">
                <div class="card bg-light shadow p-3 mb-5 bg-body rounded">
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="/farmscope/FarmScope/admin/assets/profile.png" width="150px" height="auto" />
                    </div>
                    <!-- form -->
                    <form action="./EditController.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" type="file" id="gambar" name="gambar" <?php echo $article['gambar'] ?> required />
                            </div>
