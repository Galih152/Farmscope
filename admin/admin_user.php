...
$dataproduk = query("SELECT * FROM produk_sapi");
///konfigurasi pagenation
$jumlahUser = mysqli_query($koneksi, "SELECT * FROM user WHERE username NOT LIKE 'admin'");
$jumlahUserAktif = mysqli_query($koneksi, "SELECT * FROM user WHERE status = 'aktif' AND username NOT LIKE 'admin'");
$jumlahUserTidakAktif = mysqli_query($koneksi, "SELECT * FROM user WHERE status = 'tidak aktif' AND username NOT LIKE 'admin'");
