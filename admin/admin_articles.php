<?php include("../servernya/tes_koneksi.php"); ?>
<?php 
session_start();
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-light shadow p-3  bg-body rounded">
                    ...
                    <img src="/FarmScope/admin/assets/profile.png" width="150px" height="auto" />
                    </div>
                    <!-- form -->
            ...
            <div class="col align-self-center align-items-center justify-content-center">
                <img src="/FarmScope/admin/assets/components/admin_artikel.gif" class="img-hero" />
            </div>
        </div>
    </div>
    <!-- form bootstrap end -->
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($article = mysqli_fetch_array($query)) {
                    ...
                    echo "<td><img src='/FarmScope/admin/assets/components/$article[gambar]' width='200px' height='auto' /></td>";
