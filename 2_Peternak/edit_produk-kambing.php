    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="formbold-main-wrapper">
                  ...
                  ?>
                  <form action="servernya/update_produk-kambing.php?id=<?php echo $row['id_produk']; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Berat -->
                    <div class="formbold-mb-3">
                        <label for="berat" class="formbold-form-label"> Berat </label>
                    ...
                    <div class="formbold-mb-3">
                        ...
                        <input type="text" name="harga" id="harga" class="formbold-form-input" 
