...
<body>
    ...
    <div class="container-fluid py-5">
        <?php
            ...
            ?>
            <!-- Button Edit -->
            <div class="container d-flex align-items-center justify-content-center justify-content-lg-start pt-4">
                <a href="edit_produk-kambing.php?id=<?php echo $row['id_produk']; ?>" class="btn btn-outline-dark border-2 py-md-3 px-md-5 me-5">Edit Produk</a>
            </div>
            <!-- Form Tambah -->
            <div class="container">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-12 col-lg-7">
                        <div class="card card-body shadow-sm">
                            ...
                            <h6 class="b text-muted">Stok: <?php echo $row["stok"]; ?> </h6>
                            <div class="my-2">
                                <div class="row">
                                    <div class="col-sm-12 col-lg-5">
                                        <a href="keranjang.html" class="hvnb">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>&nbsp;</td>
                                            <td class="text-website">Medan Kota</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </tbody>
                                </table>
