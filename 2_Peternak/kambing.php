    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-6 text-uppercase mb-0">List Produk - Kambing</h1>
            </div>
            <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-1">
                <a href="tambah_produk-kambing.php" class="btn btn-outline-dark border-2 py-md-3 px-md-5 me-5">Tambah Produk</a>
            </div>
            <br><br>
            <div class="row">
            <?php
