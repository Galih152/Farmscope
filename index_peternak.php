    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="2_Peternak/tips&trik.php" class="nav-item nav-link">Tips & Trik</a>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    <div class="border-start border-5 border-primary ps-5 mb-5">
                        ...
                        <h1 class="display-5 text-uppercase mb-0">Sumber Terpercaya untuk Ternak Berkualitas!</h1>
                    </div>
            ...
            <div class="row g-5">
                            ...
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="bi bi-bookmarks me-2"></i>Kambing Super</small>
                                        <small><i class="bi bi-calendar-date me-2"></i>01 Jan, 2023</small>
                                    </div>
                                    <h5 class="text-uppercase mb-3">Kambing ternyata makan makanan selain rumput!</h5>
                                    <p>Pada dasarnya kambing memang memakan rumput, tetapi tahukah kamu bahwa..</p>
                ...
                <div class="col-lg-6">
                    <div class="blog-item">
                        <div class="row g-0 bg-light overflow-hidden">
                            <div class="col-12 col-sm-5 h-100">
                                <img class="img-fluid h-100" src="img/Ayam 2.jpeg" style="object-fit: cover;">
                            </div>
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column justify-content-center">
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="bi bi-bookmarks me-2"></i>Fakta Menarik</small>
                                        <small><i class="bi bi-calendar-date me-2"></i>01 Feb, 2025</small>
                                    </div>
                                    <h5 class="text-uppercase mb-3">Ayam Berpuasa Saat Bertelur</h5>
                                    <p>Ayam bertelur selama 28 hari lamanya. Tahukah kamu bahwa ayam itu..</p>
                                    <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-body mb-2" href="2_Peternak/tips&trik.php"><i class="bi bi-arrow-right text-primary me-2"></i>Tips & Trick</a>
                        <a class="text-body mb-2" href="2_Peternak/galeri.php"><i class="bi bi-arrow-right text-primary me-2"></i>Galeri</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
